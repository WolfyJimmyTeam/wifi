...
(function($){
        ...
        String.prototype.isIpv1 = function() {
                rgx = /\b([A-F0-9]{1,2}:){5}([A-F0-9]{1,2})\b/i ;
                return rgx.test(this.toString());
        };
        $.fn.extend({
                ...
                ipAddress: function(s) {
                        ...
                        return $(this).each(function(){
                                ...
                                if(s.v == 1) thesize=17;
                                if(s.v == 6) thesize=39;
                                ctx.input.attr('maxlength',thesize).attr('size',thesize);
                                ...
                                ctx.input.bind('keydown',function(e){
                                        ...
                                        if(ctx.input.val() == '') ctx.input.val(s.label);
